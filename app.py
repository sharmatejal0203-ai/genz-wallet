...
st.markdown(
    ...
    .profile-box {
        background: linear-gradient(145deg, #171A23, #101116);
        border: 1px solid #303542;
        border-radius: 22px;
        padding: 22px;
        margin: 14px 0;
...
# =========================================================
    ...
    st.caption("Demo transaction only — no real money.")
...
# =========================================================
    ...
    st.caption("Simulated payment — no real UPI connection.")
